#include "dyros_jet_controller/hand_controller.h"

namespace dyros_jet_controller
{
 
JointController::JointController(const VectorQd& current_q_hand, const double& control_time) :
  current_q_(current_q_hand), current_time_(control_time), total_dof_(DyrosJetModel::HW_HAND_DOF),
